...
Additional some additional Master Data can be extracted directly from SAP
for analysis purposes.

::: callout-important
can only be executed from **within BioBalance Network** as a connection to SAP is needed!!!
:::
...
Gather Additional Master Data from SAP for quick analysis.
...
S4_MARA <- 
   fRead_and_Union(
     ...
     pFields   = list(
        ...
        # "BRIDGE_MAX_SLOPE"         , # Maximum Slope for Bridges [°]                                 
...
B4_MATL <- 
  ...
  setnames(
  old = c("BASE_UOM"   , "PO_UNIT"   , "PROD_HIER"   , "PLANT"   , "MTPOS"   , "i.LVORM"),
...
saveRDS(
  object = B4_MATL, 
  file   = file.path(
    pa_ds_stageing_path_get(.staging = "silver", .functional_area = "master_data", "material"), 
    "B4_MATL.rds")
  )
```
...
S4_MAST <- 
   fRead_and_Union(
     ...
     pFields   = list(
        ...
        "WERKS"             , # Plant                                              X
        # "STLAN"             , # BOM Usage                                          X
        "STLNR"             , # Bill of Material                                   X
        "STLAL"             #, # Alternative BOM                                    X
        # "LOSVN"             , # From Lot Size
        # "LOSBS"             , # To Lot Size
...
S4_KNVV <- 
   fRead_and_Union(
     ...
     pFields   = list(
        ...
        # "VERSG"                , # Customer Statistics Group                                    
        # "AUFSD"                , # Customer order block (sales area)                            
        # "KALKS"                , # Customer Classification for Pricing Procedure Determination  
        ...
        # "KTGRD"                , # Account Assignment Group for Customer                        
        # "ZTERM"                , # Terms of Payment Key                                         
        # "VWERK"                , # Delivering Plant (Own or External)                           
        # "VKGRP"                , # Sales Group                                                  
        # "VKBUR"                , # Sales Office                                                 
        # "VSORT"                , # Item proposal                                                
        # "KVGR1"                , # Forecast group                                               
        # "KVGR2"                , # Control price inv.print                                      
        # "KVGR3"                , # Shelf life group                                             
        # "KVGR4"                , # Deliv. GSL grp                                               
        ...
        # "KABSS"                , # Customer payment guarantee procedure                         
        # "KKBER"                , # Credit Control Area                                          
        # "CASSD"                , # Sales Block for Customer (Sales Area)                        
        # "RDOFF"                , # Switch off rounding?                                         
        # "AGREL"                , # Indicator: Relevant for Settlement Management                
        # "MEGRU"                , # Unit of Measure Group                                        
        ...
        # "BLIND"                , # Index Structure Active for Subsequent Settlement             
        ...
        # "INCO2_KEY"            , # Incoterm Location 1 - Place of Destination                   
        # "INCO3_KEY"            , # Incoterm Location 2 - Place of Delivery                      
        # "INCO4_KEY"            , # Incoterm - Deviating Place of Destination                    
        # "KNVV_EEW_CONTACT"     , # Data element Extension for Contact                           
        # "STATUS_OBJ_GUID"      , # Globally Unique Identifier                                   
        # "BILLPLAN_PROC"        , # Billing Plan Procedure                                       
        # "KNVV_ADDR_EEW_CUST"   , # Customer sales addr. dep. extensibility                      
        # "/BEV1/EMLGPFAND"      , # Deposit on Empties                                           
        # "/BEV1/EMLGFORTS"      , # Indicator for Empties Update                                 
        # "J_1NBOESL"            , # Exchange Key for NF Processing                               
        ...
        # "FSH_GRREG"            , # Grouping Rule                                                
        # "FSH_RESGY"            , # Release Strategy                                             
        # "FSH_SC_CID"           , # Customer/Supplier Identifier                                 
        # "FSH_VAS_DETC"         , # VAS Determination Mode                                       
        # "FSH_VAS_CG"           , # Value-Added Services Customer Group                          
        # "FSH_GRSGY"            , # ARUN Grouping Strategy                                       
        # "FSH_SS"               , # Order Scheduling Strategy                                    
        # "FSH_FRATE"            , # Fill Rate %                                                  
        # "FSH_FRATE_AGG_LEVEL"  , # Fill Rate Aggregation Level                                  
        # "FSH_MSOCDC"           , # Distribution Center of Customer                              
        # "FSH_MSOPID"           , # Customer Identification in the Partner System                
        # "RFM_PSST_RULE"        , # PSST Grouping Rule                                           
        # "RFM_PSST_EXCLUDE"     , # Exclude from PSST Grouping Rule Determination                
        # "SUPID1"               , # Account Number of Supplier                                   
        # "KONDM1"               , # Material Price Group                                         
        # "SUPID2"               , # Account Number of Supplier                                   
        # "KONDM2"               , # Material Price Group                                         
        # "SUPID3"               , # Account Number of Supplier                                   
        # "KONDM3"               , # Material Price Group                                         
        # "SUPID4"               , # Account Number of Supplier                                   
        # "KONDM4"               , # Material Price Group                                         
        # "SUPID5"               , # Account Number of Supplier                                   
        # "KONDM5"               , # Material Price Group                                         
        # "SUPID6"               , # Account Number of Supplier                                   
        # "KONDM6"               , # Material Price Group                                         
        # "ZZFIELD1"             , # Promotion Pack                                               
        # "ZZFIELD2"             , # Instore Leaflets                                             
        # "ZZFIELD3"             , # Extra field 3                                                
        # "ZZFIELD4"             , # ExtraFld4                                                    
        # "ZZFIELD5"             , # ExtraFld5                                                    
        # "ZZFIELD6"               # ExtraFld6                                                    
    ),
...
### OB - Open Hub Destination

Get a list of all available Open Hubs in BW with description and save as: B4_RSBOHDEST.csv
...
Get a list of all available Open Hub fields with description and save as: B4_RSBOHFIELDS.csv
...
RSBOHFIELDS <- 
  ...
  .[OHDEST %chin% c(
    ...
    .(OHDEST , POSIT,
      FIELDNM, TXTLG, 
      KEYFLAG, DATATYPE, LENG, CONVEXIT, DECIMALS
      )
  ] 
...
Open Hub with fields and description which are relevant for Pythia, save as: PA_OPEN_HUB.csv
...
Generate transformation rules for Open Hub fields and save as: transformation_rules_org.csv to be used by DuckDB.
