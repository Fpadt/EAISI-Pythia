...
# helper paths
PATH_PA_CNFG <- file.path(get_environment_path(), "config")
PATH_BRZ_SLS <- file.path(get_environment_path(), BSGP[1], AREA[1])
PATH_SLV_SLS <- file.path(get_environment_path(), BSGP[2], AREA[1])
PATH_BRZ_STK <- file.path(get_environment_path(), BSGP[1], AREA[2])
PATH_SLV_STK <- file.path(get_environment_path(), BSGP[2], AREA[2])
PATH_BRZ__MD <- file.path(get_environment_path(), BSGP[1], AREA[4])
PATH_SLV__MD <- file.path(get_environment_path(), BSGP[2], AREA[4])
```
...
setup_project_structure(root_dir = "C:/PW/OneDrive/ET/pythia/data")

# set the DTAP environment
set_current_environment(.environment = "Production")
