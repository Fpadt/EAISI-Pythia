...
# FILE_SPEC <- 
#   list(
#     DELIM        = pa_get_config_value(key = "DELIM"),       # ';',
#     HEADER       = pa_get_config_value(key = "HEADER"),      # FALSE,
#     DATE_FORMAT  = pa_get_config_value(key = "DATE_FORMAT")  # '%Y-%m-%d'
#   )
...
```{r}
shell.exec(normalizePath(file.path(PATH_PA_CNFG, "transformation_rules_org.csv")))
shell.exec(normalizePath(file.path(PATH_PA_CNFG, "transformation_rules_mod.csv")))
