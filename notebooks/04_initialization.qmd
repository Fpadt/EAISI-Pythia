...
::: callout-note
Note: can only be executed from **within Ecotone Network**
as a connection to SAP is needed
:::
...
B4_RSBOHFIELDS[, .(
  ...
  setorder(OHDEST, POSIT)              %>%
  fwrite(
    file = file.path(PS01, SYS, "B4", "B4_PIPELINE_ORG.csv")
  )

```

## Open CSV to modify Pipelines

```{r}
#| label:  Open Pipeline files
#| label:  true 
#| 
