...
FFNG <- file.path(PS02, SYS, "RTP", "OB", paste0("DD_SALES_QTY_20*")  ) 
FFNG <- file.path(PS02, SYS, "RTP", "OB", paste0("DD_SALES_QTY_2024*")  )
...
FFNG <- file.path(PS02, SYS, "RTP", paste0("DD_SALES_QTY_20*")  ) 
      ...
      paste0(
        "SELECT 
         ...
         WHERE 
          ...
          MATERIAL    IN ('000000000003021952')
         GROUP BY 
          ALL
         ORDER BY 
          SALESORG,
    ...
    dbGetQuery(
      ...
      paste0(
        "SELECT
         ...
         WHERE 
          SALESORG    IN ('FR30', 'NL10') AND
          MATERIAL    IN ('000000000000010023')
         GROUP BY 
          ALL
         ORDER BY 
          SALESORG,
